...
SHARED_LIB = "<KL9-RHIZOME_DIR>/skills/kailejiu-shared/lib"
...
def test_5_soul_guidance_flow():
    ...
    sys.path.insert(0, "<KL9-RHIZOME_DIR>/skills/kailejiu-soul/scripts")
...
def test_6_full_pipeline_with_soul():
    ...
    sys.path.insert(0, "<KL9-RHIZOME_DIR>/skills/kailejiu-orchestrator/scripts")
    import importlib.util
    spec = importlib.util.spec_from_file_location(
        "koordinator",
        "<KL9-RHIZOME_DIR>/skills/kailejiu-orchestrator/scripts/koordinator.py"
    )
