...
```bash
# 导入样本技能书
python -c "from kl9_skillbook.bridge import import_skillbook_to_graph; import_skillbook_to_graph('skillbooks/de/Brodbeck-Phaenomenologie_des_Geldes-2023.skillbook.json')"
