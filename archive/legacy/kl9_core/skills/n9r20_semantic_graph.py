...
from core.n9r20_structures import N9R20TermNode
...
class N9R20SemanticGraph:
    ...
    def __init__(self):
        # ═══ 核心图谱结构 ═══
        self._nodes: Dict[str, N9R20TermNode] = {}          # term → N9R20TermNode
        self._edges: Dict[Tuple[str, str], float] = {}  # (term_a, term_b) → weight (按字母序排列)
        self._clusters: Dict[str, N9R20ConceptCluster] = {}  # cluster_id → N9R20ConceptCluster
    ...
    def add_term(self, term: str, source_session: str = "", confidence: float = 0.7) -> N9R20TermNode:
        """
    ...
    def detect_clusters(self, min_cluster_size: int = 3) -> List[N9R20ConceptCluster]:
        """
        社区发现：基于边权重的概念簇检测
