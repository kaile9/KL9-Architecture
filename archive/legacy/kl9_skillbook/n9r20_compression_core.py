...
from core.n9r20_structures import N9R20DualState, N9R20CompressedOutput, N9R20RoutingDecision, N9R20Perspective, N9R20Tension, N9R20PerspectiveType
from core.n9r20_tension_bus import N9R20TensionBus, n9r20_bus, N9R20CompressionTensionEvent, N9R20CompressionCompleteEvent
...
class N9R20CompressionCore:
    ...
    def _four_mode_fold(self, state: N9R20DualState, 
                       routing: N9R20RoutingDecision) -> N9R20DualState:
        """
        四模编码驱动的动态折叠
